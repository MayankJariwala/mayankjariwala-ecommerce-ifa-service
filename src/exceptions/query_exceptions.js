...
// specific exception
class AlreadyMarkedCompleteOrRecordNotFound extends Exception {
	constructor(message = "Auction is already marked as completed or either record not present", stack = {}) {
		super("RecordNotFoundException", message);
		this.message = message;
	}
...
module.exports = {
	...
	AlreadyMarkedCompleteOrRecordNotFound
};
